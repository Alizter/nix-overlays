    ...
    ocaml-ng.mkOcamlPackages (
      (callPackage (import "${nixpkgs}/pkgs/development/compilers/ocaml/generic.nix" {
        ...
        (
          ...
          // (
            if lib.isFunction (extraOpts.overrideAttrs or null) then extraOpts.overrideAttrs o else extraOpts
          )
        )
    );
      ...
      if !(ocaml-ng ? "ocamlPackages_trunk") then
        {
          ...
          ocamlPackages_5_5 = newOCamlScope {
            ...
            src = super.fetchFromGitHub {
              ...
              repo = "ocaml";
              rev = "5.5.0-alpha3";
              hash = "sha256-w3WRS5T5A/VWxCsIXAF7fhWVryf/hRTufG14UTWR3r0=";
              fetchSubmodules = true;
            };
          };
